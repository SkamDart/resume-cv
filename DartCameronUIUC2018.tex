...
\rhead{
  ...
  {Phone:} (630) 200-2504
  {Email: }\href{mailto:camerondart@protonmail.com}{camerondart@protonmail.com}
  {Github:} \href{https://github.com/SkamDart}{skamdart}
  %{StackOverflow} \href{https://stackoverflow.com/users/4276090/see-dart}{see-dart}
  {LinkedIn:} \href{https://www.linkedin.com/in/cdart2/}{cdart2}
...
\fi
  ...
  \begin{details}
    \item \hyperlink{https://patents.justia.com/patent/11916279}{Modular system for detecting, tracking and transmitting to identified objects (2024202362)}
        ...
        % \item Abstract submitted and featured in 2017 Blue Waters Project Annual Report
  \end{details}
